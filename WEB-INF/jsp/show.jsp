...
<%--          <li ><a href="/myMsg">我的主页</a></li>--%>
          ...
          <li style="float: left;"><a href="/myBuy">${user.name}</a> </li>
                  ...
                  <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                      <div class="item active">
                        <img id="img1" src="images/banner2.png" alt="First slide">
                      </div>
                      <div class="item">
                        <img  id="img2" src="images/banner4.png" alt="Second slide">
                      </div>
                      <div class="item">
                        <img id="img3" src="images/banner4.jpg" alt="Third slide">
                      </div>
                    </div>
                    <!-- 轮播（Carousel）导航 -->
